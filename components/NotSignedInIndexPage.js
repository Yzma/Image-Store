...
export const NotSignedInHomepage = () => {
  return (
    <>
        ...
        <Container>
          <Row className="mb-5">
            <Col xs={12} className="text-center">
              ...
              <h1 className="fw-bolder text-secondary">Bug Smash</h1>
      ...
      <footer className="footer py-6 bg-dark text-white">
        <Container>
          <Row className="d-flex justify-content-center align-items-center">
            <Col md={4}>
              <Navbar.Brand to="#home" className="me-lg-3 mb-3 d-flex align-items-center">
                <Image src={ReactHero} />
            ...
            <Col className="mb-md-2">
              <div className="d-flex text-center justify-content-center align-items-center" role="contentinfo">
                <p className="font-weight-normal font-small mb-0">Copyright © Andrew Caruso 2021. All rights reserved.<br />
                  Powered by <a href="https://themesberg.com/product/dashboard/volt-react">Volt</a>, NextJS and MongoDB.</p>
              </div>
            </Col>
          </Row>
        </Container>
