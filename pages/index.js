...
import { faBook, faExternalLinkAlt, faCalendarAlt, faCodeBranch, faShoppingCart, faFolder, faMapMarkedAlt, faPager } from "@fortawesome/free-solid-svg-icons";
import { faBootstrap, faReact, faSass } from "@fortawesome/free-brands-svg-icons";
import { Col, Row, Image, Card, Button, Container, ListGroup, Tooltip, OverlayTrigger, Form, Navbar, Nav, Badge } from '@themesberg/react-bootstrap';
      ...
      <Navbar variant="dark" expand="lg" bg="dark" className="navbar-transparent navbar-theme-primary sticky-top">
        <Container className="position-relative justify-content-between px-3">
          <Navbar.Brand to="#home" className="me-lg-3 d-flex align-items-center">
            <Image src={ReactHero} />
            <span className="ms-2 brand-text d-none d-md-inline">Shopify Backend Challenge</span>
          </Navbar.Brand>
          ...
          <div className="d-flex align-items-center">
            <Navbar.Collapse id="navbar-default-primary">
              <Nav className="navbar-nav-hover align-items-lg-center">
                ...
                <Nav.Link href="#folder" className="d-sm-none d-xl-inline">Folder Structure</Nav.Link>
                <Nav.Link href="#download">Upgrade to Pro</Nav.Link>
              </Nav>
            </Navbar.Collapse>

            {!session ? (
               <Button onClick={() => signIn()} variant="outline-white" className="ms-3">Sign In</Button>
              ) : (
              <div  className="media d-flex align-items-center">
                <a href={`/users/${session.user.id}`} ><Image src={session.user.image} className="user-avatar md-avatar rounded-circle" /></a>
              </div>
            )}
        ...
        <Container>
          <Row className="mb-5">
            <Col xs={12} className="text-center">
              ...
              <h1 className="fw-bolder text-secondary">Shopify Backend Challenge</h1>
              <p className="text-muted fw-light h5">An image hosting repository, with the ability to sell and purchase images.</p>
              <p className="text-muted fw-light h5">Created with NextJS, PostgreSQL and Volt.</p>
          ...
          <Row>
            <Col className="mb-md-2">
              <div className="d-flex text-center justify-content-center align-items-center" role="contentinfo">
                <p className="font-weight-normal font-small mb-0">Copyright © Andrew Caruso 2021. All rights reserved.<br />
                  Created with NextJS, PostgreSQL and Volt.</p>
              </div>
            </Col>
          </Row>
        </Container>
